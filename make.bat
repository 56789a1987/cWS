...
cl /std:c++20 /I src/headers/21 /I targets/node-%v120%/include/node /I targets/node-%v120%/deps/uv/include /I targets/node-%v120%/deps/v8/include /I targets/node-%v120%/deps/openssl/openssl/include /I targets/node-%v120%/deps/zlib /EHsc /Ox /LD /Fedist/bindings/cws_win32_120.node src/*.cpp targets/node-%v120%/node.lib
