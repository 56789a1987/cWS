...
|-------------|----------|---------|------------------|-----------|---------|-----------------|---------|---------|
| 4.3.0       |    X     |    X    | >=12.18          |     X     | >=14.5  | >=16.18         | >=18.0  | >=19.2  |
| 4.2.0       |    X     |    X    | >=12.18          |     X     | >=14.5  | >=16.0 & <16.18 | >=18.0  | >=19.0  |
| 4.1.0       |    X     |    X    | >=12.18          |     X     | >=14.5  | >=16.0 & <16.18 | >=18.0  |    X    |
| 4.0.0       |    X     |    X    | >=12.18          |     X     | >=14.5  | >=16.0 & <16.18 |    X    |    X    |
