...
| CWS Version | Node 18 | Node 20 | Node 21 | Node 22 | Node 23 | Node 24 | Node 25 | Node 26 |
|-------------|---------|---------|---------|---------|---------|---------|---------|---------|
| 4.11.0      |    X    |    X    |    X    | >=22.21 |    X    | >=24.15 | >=25.9  | >=26.1  |
| 4.10.0      |    X    | >=20.19 |    X    | >=22.21 |    X    | >=24.11 | >=25.1  |    X    |
| 4.9.0       | >=18.20 | >=20.19 |    X    | >=22.16 |    X    | >=24.1  |    X    |    X    |
| 4.8.0       | >=18.20 | >=20.18 |    X    | >=22.10 | >=23.0  |    X    |    X    |    X    |
| 4.7.0       | >=18.20 | >=20.12 | >=21.7  | >=22.0  |    X    |    X    |    X    |    X    |
