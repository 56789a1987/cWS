...
|  CWS Version | Node 10  | Node 11 | Node 12          |  Node 13  | Node 14 | Node 16 | Node 18 |
|--------------|----------|---------|------------------|-----------|---------|---------|---------|
| 4.1.0        |    X     |    X    | >=12.18          |     X     | >=14.19 | >=16.14 | >=18.2  |
| 4.0.0        |    X     |    X    | >=12.18          |     X     | >=14.19 | >=16.14 |    X    |
| 3.0.0        | >=10.0   |    X    | >=12.16          | >=13.9    | >=14.5  |    X    |    X    |
| 2.0.0        | >=10.0   |    X    | >=12.16          | >=13.9    |   X     |    X    |    X    |
| 1.6.0        | >=10.0   | >=11.0  | >=12.0 & <12.16  | >=13.9    |   X     |    X    |    X    |
