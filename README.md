...
* Due to [a libuv update](https://github.com/libuv/libuv/pull/3952), if you're running cWS on Linux and using new versions of Node (>= 18.18, >= 20.3, ...), you need to set the environment variable `UV_USE_IO_URING=0` or multiple connections may break.
...
| CWS Version | Node 12 | Node 13 | Node 14 | Node 16         | Node 18         | Node 19 | Node 20 | Node 21 |
|-------------|---------|---------|---------|-----------------|-----------------|---------|---------|---------|
| 4.6.0       |    X    |    X    |    X    | >=16.20         | >=18.18         |    X    | >=20.9  | >=21.1  |
| 4.5.0       |    X    |    X    | >=14.21 | >=16.20         | >=18.18         |    X    | >=20.7  |    X    |
| 4.4.0       |    X    |    X    | >=14.20 | >=16.18         | >=18.13         |    X    | >=20.0  |    X    |
| 4.3.0       | >=12.18 |    X    | >=14.5  | >=16.18         | >=18.13         | >=19.2  |    X    |    X    |
| 4.2.0       | >=12.18 |    X    | >=14.5  | >=16.0 & <16.18 | >=18.0 & <18.13 | >=19.0  |    X    |    X    |
| 4.1.0       | >=12.18 |    X    | >=14.5  | >=16.0 & <16.18 | >=18.0 & <18.13 |    X    |    X    |    X    |
| 4.0.0       | >=12.18 |    X    | >=14.5  | >=16.0 & <16.18 |    X            |    X    |    X    |    X    |
