...
| CWS Version | Node 14 | Node 16         | Node 18         | Node 19 | Node 20 | Node 21 | Node 22 | Node 23 | Node 24 | Node 25 |
|-------------|---------|-----------------|-----------------|---------|---------|---------|---------|---------|---------|---------|
| 4.10.0      |    X    |    X            |    X            |    X    | >=20.19 |    X    | >=22.21 |    X    | >=24.11 | >=25.1  |
| 4.9.0       |    X    |    X            | >=18.20         |    X    | >=20.19 |    X    | >=22.16 |    X    | >=24.1  |    X    |
| 4.8.0       |    X    |    X            | >=18.20         |    X    | >=20.18 |    X    | >=22.10 | >=23.0  |    X    |    X    |
| 4.7.0       |    X    |    X            | >=18.20         |    X    | >=20.12 | >=21.7  | >=22.0  |    X    |    X    |    X    |
| 4.6.0       |    X    | >=16.20         | >=18.18         |    X    | >=20.9  | >=21.1  |    X    |    X    |    X    |    X    |
| 4.5.0       | >=14.21 | >=16.20         | >=18.18         |    X    | >=20.7  |    X    |    X    |    X    |    X    |    X    |
| 4.4.0       | >=14.20 | >=16.18         | >=18.13         |    X    | >=20.0  |    X    |    X    |    X    |    X    |    X    |
| 4.3.0       | >=14.5  | >=16.18         | >=18.13         | >=19.2  |    X    |    X    |    X    |    X    |    X    |    X    |
| 4.2.0       | >=14.5  | >=16.0 & <16.18 | >=18.0 & <18.13 | >=19.0  |    X    |    X    |    X    |    X    |    X    |    X    |
| 4.1.0       | >=14.5  | >=16.0 & <16.18 | >=18.0 & <18.13 |    X    |    X    |    X    |    X    |    X    |    X    |    X    |
| 4.0.0       | >=14.5  | >=16.0 & <16.18 |    X            |    X    |    X    |    X    |    X    |    X    |    X    |    X    |
